...
if ($admin_area == 'all') {
    ...
    switch ($admin_area) {
        case 'surabaya':
            $area = "AND b.kota_kontak IN ('surabaya','tuban', 'sidoarjo', 'gersik', 'lamongan', 'mojokerto', 'jombang', 'nganjuk', 'madiun', 'ngawi', 'ponorogo', 'pacitan', 'trenggalek', 'tulungagung', 'blitar')";
            break;
        case 'probolinggo':
        ...
        case 'juwana' or 'juwono':
            $area = " AND b.kota_kontak IN ('juwano', 'jepara', 'kudus', 'pati', 'rembang', 'blora')";
            break;
        case 'cirebon':
